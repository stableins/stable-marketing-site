    ...
    <Row className="align-items-center justify-content-center">
      <Col xs="12" className="col-xl-5 col-lg-5 col-md-7 col-xs-8">
        <About.Image mb="30px" mbLG="0">
          <Img src="../../../assets/image/home-services/about-us-image-l4-1.png" alt="about" layout="fullWidth" placeholder="blurred"/>
          <About.ImageInner>
            <Img src="../../../assets/image/home-services/about-us-image-l4-2.png" alt="about" layout="fullWidth" placeholder="blurred"/>
          </About.ImageInner>
        </About.Image>
      </Col>
