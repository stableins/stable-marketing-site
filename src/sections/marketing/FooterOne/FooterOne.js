            ...
            <Row>
              <Col xs="12" className="col-lg-4 col-md-8 col-xs-10">
                <Footer.Widgets className="footer-widgets footer-widgets--l7">
                  <Footer.Box mb="30px"></Footer.Box>
                </Footer.Widgets>
              </Col>
              <Col xs="12" className="col-xl-8">
                <Row>
                  <Col xs="6" className="col-md-4 col-xs-6"></Col>
                  <Col xs="6" className="col-md-4 col-xs-6"></Col>
      ...
      >
        ...
        <div className="terms-wrapper">
          ...
          <p className="paragraph-7">
            The website located at www.stableins.com (the “<strong>Site</strong>
            ”) is a copyrighted work belonging to Stable Insurance, Inc. (“
            <strong>Company</strong>”, “<strong>us</strong>”, “
            <strong>our</strong>
            ”, and “<strong>we</strong>”).  Certain features of the Site may be
          ...
          <p>
            ...
            className ACTIONS, AND ALSO LIMIT THE REMEDIES AVAILABLE TO YOU IN
          ...
          <div>
            ...
            <ul className="list-no-style">
              <li className="list-item">
                ...
                (“
                <strong>Account</strong>”) and provide certain information about
              ...
              <li>
                ...
                login information and are fully responsible for all activities
          ...
          <div>
            ...
            <ul className="list-no-style">
              ...
              <li className="list-item">
                ...
                build a similar or competitive website, product, or service; and
              ...
              <li className="list-item">
                ...
                right, at any time, to modify, suspend, or discontinue the Site
                (in whole or in part) with or without notice to you. You agree
                that Company will not be liable to you or to any third party for
                any modification, suspension, or discontinuation of the Site or
                any part thereof.
              </li>
              <li className="list-item">
              ...
              <li className="list-item">
                2.5     <strong>Ownership. </strong>Excluding any User Content
                that you may provide (defined below), you acknowledge that all
                the intellectual property rights, including copyrights, patents,
                trade marks, and trade secrets, in the Site and its content are
                owned by Company or Company’s suppliers. Neither these Terms
                (nor your access to the Site) transfers to you or any third
                party any rights, title or interest in or to such intellectual
                property rights, except for the limited access rights expressly
                set forth in Section 2.1. Company and its suppliers reserve all
                rights not granted in these Terms. There are no implied licenses
          ...
          <div>
            ...
            <ul>
              <li className="list-no-style">
                3.1     <strong>User Content. “User Content”</strong> means any
                and all information and content that a user submits to, or uses
                with, the Site (e.g., content in the user’s profile or
                postings). You are solely responsible for your User Content.
                ...
                our Acceptable Use Policy (defined in Section 3.3).  You may not
                represent or imply to others that your User Content is in any
                way provided, sponsored or endorsed by Company.  Because you
              ...
              <li className="list-no-style">
                3.3     <strong>Acceptable Use Policy. </strong>The following
                terms constitute our “<strong>Acceptable Use Policy</strong>”:
              </li>
              <li className="list-no-style">
                <ol className="list-2">
                  <li className="list-item">
                    ...
                    group or individual or is otherwise objectionable; (iii)
                  ...
                  <li className="list-item">
                    ...
                    whether commercial or otherwise; (iii) use the Site to
                    ...
                    undue burden on servers or networks connected to the Site,
                    or violate the regulations, policies or procedures of such
                    networks; (v) attempt to gain unauthorized access to the
                    Site (or to other computer systems or networks connected to
                    or used together with the Site), whether through password
                    ...
                    requests, or queries to (or to strip, scrape, or mine data
                    from) the Site (provided, however, that we conditionally
              ...
              <li className="list-no-style">
                3.4     <strong>Enforcement. </strong>We reserve the right (but
                have no obligation) to review any User Content, and to
              ...
              <li className="list-no-style">
                3.5     <strong>Feedback. </strong>If you provide Company with
                any feedback or suggestions regarding the Site (“Feedback”), you
          ...
          <div>
            ...
            <ul className="list-no-style">
              <li className="list-item">
                5.1     <strong>Third-Party Links &amp; Ads. </strong>The Site
                may contain links to third-party websites and services, and/or
              ...
              <li className="list-item">
                5.2     <strong>Other Users. </strong>Each Site user is solely
                ...
                currency, suitability, or quality of any User Content.  Your
                interactions with other Site users are solely between you and
                such users. You agree that Company will not be responsible for
              ...
              <li className="list-item">
                5.3     <strong>Release. </strong>You hereby release and forever
                ...
                indirectly to, the Site (including any interactions with, or act
                or omission of, other Site users or any Third-Party Links &amp;
          ...
          <div>
            ...
            <ul className="list-no-style">
              <li className="list-item">
                ...
                use the Site will terminate immediately.  You understand that
                any termination of your Account may involve deletion of your
                User Content associated with your Account from our live
                databases. Company will not have any liability whatsoever to you
                for any termination of your rights under these Terms, including
                ...
                in effect: Sections 2.2 through 2.5, Section 3 and Sections 4
                through 10.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              <li className="list-no-style">
                10.1     <strong>Changes.</strong> These Terms are subject to
                ...
                (if applicable) or thirty (30) calendar days following our
              ...
              <li className="list-no-style">
                <ol className="sub-list--letter">
                  <li className="list-item">
                    ...
                    with the Terms or the use of any product or service provided
                    by the Company that cannot be resolved informally or in
                    small claims court shall be resolved by binding arbitration
                    on an individual basis under the terms of this Arbitration
                  ...
                  <li className="list-item">
                    ...
                    should be sent to: 81 Prospect Street, , Brooklyn, New York
                    11201.  After the Notice is received, you and the Company
                    ...
                    party may begin an arbitration proceeding.  The amount of
                    any settlement offer made by any party may not be disclosed
                  ...
                  <li className="list-item">
                    ...
                    <strong>“ADR Provider”</strong>) that offers arbitration as
                    set forth in this section. If AAA is not available to
                    arbitrate, the parties shall agree to select an alternative
                    ADR Provider. The rules of the ADR Provider shall govern all
                    aspects of the arbitration, including but not limited to the
                    method of initiating and/or demanding arbitration, except to
                    the extent such rules are in conflict with the Terms. The
                    ...
                    than Ten Thousand U.S. Dollars (US $10,000.00) may be
                    ...
                    party shall bear its own costs (including attorney’s fees)
                    and disbursements arising out of the arbitration and shall
                  ...
                  <li className="list-item">
                    ...
                    action must be initiated and/or demanded within the statute
                    of limitations (i.e., the legal deadline for filing a claim)
                  ...
                  <li className="list-item">
                    ...
                    the dispute will not be consolidated with any other matters
                  ...
                  <li className="list-item">
                    ...
                    RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT OF A JUDGE
                    OR A JURY, instead electing that all claims and disputes
                  ...
                  <li className="list-item">
                    <strong>
                      <em>
                        Waiver of className or Consolidated Actions. ALL CLAIMS
                        AND DISPUTES WITHIN THE SCOPE OF THIS ARBITRATION
                        AGREEMENT MUST BE ARBITRATED OR LITIGATED ON AN
                        INDIVIDUAL BASIS AND NOT ON A className BASIS, AND
                        CLAIMS OF MORE THAN ONE CUSTOMER OR USER CANNOT BE
                        ARBITRATED OR LITIGATED JOINTLY OR CONSOLIDATED WITH
                  ...
                  <li className="list-item">
                    ...
                    agree to maintain confidentiality unless otherwise required
                    by law.  This paragraph shall not prevent a party from
                    submitting to a court of law any information necessary to
                    enforce this Agreement, to enforce an arbitration award, or
                  ...
                  <li className="list-item">
                    ...
                    competent jurisdiction, then such specific part or parts
                  ...
                  <li className="list-item">
                    ...
                    Arbitration Agreement may be waived by the party against
                  ...
                  <li className="list-item">
                    ...
                    request for interim measures shall not be deemed a waiver of
                    any other rights or obligations under this Arbitration
                    Agreement.
                  </li>
                  <li className="list-item">
                    <strong>
                  ...
                  <li className="list-item">
                    ...
                    of the courts located within Kings County, New York, for
                    such purpose 
                  </li>
                </ol>
              </li>
              ...
              <li className="list-no-style">
                10.4     <strong>Disclosures.</strong> Company is located at the
              ...
              <li className="list-no-style">
                10.6     <strong>Entire Terms.</strong> These Terms constitute
              ...
              <li className="list-no-style">
                ...
                Copyright © 2018 Stable Insurance, Inc. All rights reserved. 
      ...
      >
        ...
        <div className="policy-wrapper">
          ...
          <p className="paragraph-5">
            <strong className="bold-text">Last Updated: August 30, 2018</strong>
          </p>
          <p className="paragraph-4">
            This privacy policy (“<strong>Policy</strong>”) describes how Stable
            Insurance, Inc. and its related companies (“
            <strong>Company</strong>
            ”) collect, use and share personal information of consumer users of
            this website, www.stableins.com (the “<strong>Site</strong>”). This
          ...
          <p>
            ...
            postal address, email address, phone number, username, demographic
            information (such as your gender and occupation) as well as other
          ...
          <p>
            ...
            a page, access times and information about your use of and actions
            on our Site. 
            <br />
          </p>
          <p>
            ...
            <li className="sub-list">
              <ul>
                ...
                <li>
                  ...
                  Stable Insurance, Inc., our agents, customers, and others.
                  This includes enforcing our agreements, policies, and terms of
                  use.
                </li>
                <li>
