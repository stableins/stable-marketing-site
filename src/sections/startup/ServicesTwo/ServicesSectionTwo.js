...
<Service backgroundColor="rgba(230, 248, 249, 0.4)">
  <Container>
    <Row className="align-items-center justify-content-center">
      ...
      <Col xs="12" className="col-xl-7 col-lg-6 col-md-6 col-xs-10 order-1 order-lg-2">
        <Service.Box>
          <Row>
            <Col xs="12" className="col-lg-6 pt-lg-7 mb-5 mb-lg-0">
              <Service.Image>
                <Img className="w-100" src="../../../assets/image/home-startup/services-img-1.png" alt="content" layout="fullWidth" placeholder="blurred"/>
              </Service.Image>
            </Col>
            <Col xs="12" className="col-lg-6 mb-5 mb-lg-0">
              <Service.Image>
                <Img className="w-100" src="../../../assets/image/home-startup/services-img-2.png" alt="content" layout="fullWidth" placeholder="blurred"/>
              </Service.Image>
            </Col>
          </Row>
        </Service.Box>
