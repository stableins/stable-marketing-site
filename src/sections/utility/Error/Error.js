    ...
    <Row className="justify-content-center">
      <Col xs="12" className="col-xl-6 col-lg-7 col-md-8 col-xs-10">
        <ErrorPage.Image className="error-page__image text-center">
          ...
          <ErrorPage.Text>The page you are looking for is not available or<br className="d-none d-xs-block" /> doesn’t belong to this website!</ErrorPage.Text>
        <ErrorPage.ButtonGroup>
          <ErrorPage.Button className="btn-readical-red btn-1" to="#">Go back</ErrorPage.Button>
          <ErrorPage.Button className="btn-outline-readical-red btn-2" to="#">Contact us</ErrorPage.Button>
        </ErrorPage.ButtonGroup>
      </Col>
    </Row>
  </Container>
