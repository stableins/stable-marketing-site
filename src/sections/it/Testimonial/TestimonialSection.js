    ...
    <Testimonial.SliderWrapper>
        ...
        >
            <Col className="col-lg-4 col-md-12">
                <TestimonialCard text="But the majorityThere are many variations passages of Lorem lpsum available,  have suffered alteration in some form, by injected or randomised." title="Snow Doe" image={Images.itServices.testiMonialUserImg1}/>
            </Col>
            <Col className="col-lg-4 col-md-12">
                <TestimonialCard text="Injected or randomised. There are many variations passages of Lorem lpsum available, but the majority have suffered alteration in some form, by " title="John Doe" image={Images.itServices.testiMonialUserImg2}/>
            </Col>
            <Col className="col-lg-4 col-md-12">
