...
<PortfolioCard>
  <Container>
    ...
    <Row className="justify-content-center">
      ...
      <Card image={Images.PortFolioMas4.PortFoliosImg8} title="Agency Brand guide" text="UX and UI, Design" />
      </Col>
      <Col xs="12" className="col-lg-4 col-md-6 col-xs-6">
      <Card image={Images.PortFolioMas4.PortFoliosImg4} title="Agency Brand guide" text="UX and UI, Design" />
      </Col>
      <Col xs="12" className="col-lg-4 col-md-6 col-xs-6">
      <Card image={Images.PortFolioMas4.PortFoliosImg8} title="Agency Brand guide" text="UX and UI, Design" />
      </Col>
