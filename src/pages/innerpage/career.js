...
export default function Career() {
  return (
    <PageWrapper innerPage={true}>
        <BreadCrumbSection title="Career with Fastland" text="Our focus is always on finding the best people to work with. Our<br class='d-none d-xs-block d-sm-none d-md-block'/>
